export const Resume = () => {
  return (
    <section id="resume" className="flex flex-col py-10 gap-10 justify-center items-center">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-3">
                ...
                <div className="flex items-center bg-white bg-opacity-20 rounded-full px-4 py-1">
                  ...
                  <span className="text-sm">
                    linkedin.com/in/umairarshad-dev
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="col-span-2">
              <div className="mb-8">
                ...
                <p className="text-gray-600">
                  I'm a dedicated Frontend Developer with expertise in React,
                  Remix, and TypeScript, focused on crafting scalable,
                  high-performance web applications. I specialize in creating
                  seamless user experiences through clean, efficient, and
                  responsive UI design. With a strong foundation in modern web
                  technologies, I enjoy solving complex problems and building
                  interactive digital solutions. I'm always eager to learn,
                  innovate, and contribute to projects that make an impact.
                </p>
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="mb-6 relative pl-6 border-l-2 border-blue-200">
                  ...
                  <h3 className="text-lg font-bold text-gray-800">
                    Pakipreneurs | Frontend Developer
                  </h3>
                ...
                <div className="relative pl-6 border-l-2 border-blue-200">
                  <div className="absolute -left-1.5 top-1.5 w-3 h-3 rounded-full bg-blue-600"></div>
                  <h3 className="text-lg font-bold text-gray-800">
                    Urbanloop Tech | Frontend Developer
                  </h3>
                  <p className="text-blue-600 font-medium text-sm mb-2">
                  ...
                  <ul className="list-disc pl-5 text-sm text-gray-600 space-y-1">
                    <li>
                      Built and optimized web applications with React.js, Remix,
                      and TypeScript to enhance performance
                    </li>
                    <li>
                      Designed and implemented responsive UI components using
                      Tailwind CSS for cross-device compatibility
                    </li>
                    <li>
                    ...
                    <li>
                      Focused on performance optimization, accessibility, and
                  ...
                  <p className="text-sm text-gray-600">
                    React.js | Remix | TypeScript | JavaScript | Tailwind CSS |
                    API Integrations | UI/UX Development | Performance
                    Optimization
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-sm">
                      portfolio-five-flame-90.vercel.app
                    </span>
                  </div>
                </div>
              </div>
